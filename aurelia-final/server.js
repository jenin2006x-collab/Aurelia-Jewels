...
const server=http.createServer(async(req,res)=>{
  ...
  const filePath=path.resolve(ROOT,'.'+reqPath);if(!filePath.startsWith(ROOT+path.sep)){res.writeHead(403);return res.end('Forbidden');}
...
server.listen(PORT,()=>console.log(`Aurelia Jewels full-stack server: http://localhost:${PORT}/`));
